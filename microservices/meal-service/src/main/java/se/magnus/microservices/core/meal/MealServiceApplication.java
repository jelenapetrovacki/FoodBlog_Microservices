...
public class MealServiceApplication {
	...
	public void initIndicesAfterStartup() {
		...
		ReactiveIndexOperations indexOps = mongoTemplate.indexOps(MealEntity.class);
		resolver.resolveIndexFor(MealEntity.class).forEach(e -> indexOps.ensureIndex(e).block());
	}
